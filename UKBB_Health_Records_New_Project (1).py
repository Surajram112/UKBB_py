...
# Load baseline table
run_command("curl https://raw.githubusercontent.com/hdg204/UKBB/main/new_baseline.py > new_baseline.py")
...
run_command('curl https://raw.githubusercontent.com/hdg204/UKBB/main/Generate_GRS.sh > Generate_GRS.sh')
